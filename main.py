...
lead_Time = st.number_input(label="Lead Time", step=1)
...
Arrival_Month = st.number_input(label="Arrival Month", step=1)
Arrival_Date = st.number_input(label="Arrival Date", step=1)
...
avg_price = st.number_input(label="Average Room Price", step=0.01)
